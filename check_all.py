...
files = [
    ...
    r"environments\staging\main.tf",
    r"environments\staging\variables.tf",
    r"environments\prod\main.tf",
    r"environments\prod\variables.tf",
]
...
for f in files:
    ...
    status = "OK" if exists and size > 10 else ("EMPTY" if exists else "MISSING")
    print(f"{status:8} {f}")
